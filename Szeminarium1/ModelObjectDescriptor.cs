...
namespace GrafikaSzeminarium
{
    ...
    internal class ModelObjectDescriptor:IDisposable
    {
        ...
        public static unsafe ModelObjectDescriptor CreateCubeWithFaceColors(GL Gl, float[] face1Color, float[] face2Color, float[] face3Color, float[] face4Color, float[] face5Color, float[] face6Color)
        {
